...
public class CareHandler extends GeneralException {
    ...
    public static final GeneralException JOURNAL_INVALID_SELECTION =
    ...
    public static final GeneralException NOT_CURRENT_WORKER =
            new CareHandler(ErrorStatus.CARE_NOT_CURRENT_WORKER);
