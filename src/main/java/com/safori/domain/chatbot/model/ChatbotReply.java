...
public record ChatbotReply(
    ...
    public static ChatbotReply crisis(String address) {
        ...
        return new ChatbotReply(
                name + "지금 많이 힘드신 마음이 느껴져서 도란이도 걱정이 됩니다. 이건 혼자 견디실 일이 아니에요.",
                "위기 상황",
                "지금은 도란이와 이야기를 이어가는 것보다, 사람이 직접 곁에서 도와드리는 것이 먼저입니다. "
                        + "자살예방 상담전화 109는 24시간 무료로 연결되고, 급하실 때는 119로 바로 연락하셔도 됩니다.",
                "지금 곁에 계신 분이나 가족에게 이 마음을 꼭 알려주세요. 혼자 두지 않을 사람이 반드시 있습니다.",
                "이렇게 마음을 꺼내 주신 것만으로도 큰 용기입니다. 도란이는 언제나 어르신 편이에요.",
                "anxiety"
        );
    }
