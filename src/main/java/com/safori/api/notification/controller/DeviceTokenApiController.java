...
@Tag(name = "device-token",
     extensions = @Extension(properties = @ExtensionProperty(name = "x-displayName", value = "[디바이스 토큰]")),
     description = "FCM 푸시 알림용 디바이스 토큰 등록/삭제 API.")
@RestController
...
public class DeviceTokenApiController {
    ...
    @Operation(operationId = "register", summary = "디바이스 토큰 등록",
    ...
    @Operation(operationId = "delete", summary = "디바이스 토큰 삭제",
