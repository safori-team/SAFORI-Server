...
@Tag(name = "user",
     extensions = @Extension(properties = @ExtensionProperty(name = "x-displayName", value = "[유저]")),
     description = "회원가입 및 내 정보 조회 API.")
@RestController
...
public class UserApiController {
    ...
    @Operation(operationId = "signUp", summary = "회원가입",
    ...
    @Operation(operationId = "getUserInfo", summary = "내 정보 조회",
            description = """
